...
import ReportFullscreenEffect from './report/ReportFullscreenEffect';
...
class ReportScreen extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            isFullscreenEffectVisible: false,
        };
    }
    ...
    componentDidMount() {
        ...
        setInterval(() => {
            this.setState((prevState) => ({isFullscreenEffectVisible: !prevState.isFullscreenEffectVisible }));
        }, 7000);
    }
    ...
    render() {
        ...
        return (
            <>
                <ReportFullscreenEffect shouldPlay={this.state.isFullscreenEffectVisible} animatedText='🌈🙈🐸'/>
